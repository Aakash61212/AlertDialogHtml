...
public static class Builder {
    ...
    private AlertDialogHtmlListner positiveListener, negativeListener;
    ...
    public void build() {
        ...
        TextView btnNegativeText = v.findViewById(R.id.tv_alert_dialog_layout_cancel_text),
                btnPositiveText = v.findViewById(R.id.tv_alert_dialog_layout_confirm_text);

        View btnNegative = v.findViewById(R.id.v_alert_dialog_layout_cancel),
                btnPositive = v.findViewById(R.id.v_alert_dialog_layout_confirm);

        View buttonDivider = v.findViewById(R.id.v_alert_dialog_layout_button_divider);

        Guideline leftImageGL = v.findViewById(R.id.gl_alert_dialog_layout_image_left),
                rightImageGL = v.findViewById(R.id.gl_alert_dialog_layout_image_right);
        ...
        if (positiveBtnText != null) {
            btnPositiveText.setText(Html.fromHtml(positiveBtnText));
        }

        if (negativeBtnText != null) {
            btnNegativeText.setText(Html.fromHtml(negativeBtnText));
        }
